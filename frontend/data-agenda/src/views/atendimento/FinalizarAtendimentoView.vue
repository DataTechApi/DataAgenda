...
export default {
  ...
  components: { Textarea, InputText, Button, DatePicker, ModalSucesso },
  setup() {
    ...
    const finalizarAtendimento = async () => {
      try {
        ...
        modalRef.value.abrir("Atendimento finalizado com sucesso!", {
          tipo: "sucesso",
          onConfirm: () => router.push("/atendimento"),
        });
      } catch (error) {
    ...
    return { manutencao, finalizarAtendimento, contadorDescricao, modalRef };
  },
};
</script>
