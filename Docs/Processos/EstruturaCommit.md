...
Os commits devem seguir o seguinte padrão estabelecido para manter a consistência e a clareza no repositório.

## Formato do Commit:
```
<tipo>: #Tarefa <descrição em tom de ação direta>
